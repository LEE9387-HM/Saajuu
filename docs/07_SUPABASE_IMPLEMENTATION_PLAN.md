...
작성일: 2026-07-11  
상태: 초기 스키마와 advisor 보강 마이그레이션을 원격 DB에 적용 완료.
...
| 함수 | 역할 |
|---|---|
| `create-consultation-session` | 이용권/체험권 확인 후 상담 세션 생성 |
...
| `accept-relationship-invite` | 초대 토큰 검증 후 양방향 인연 링크 생성 |
...
4. 관계 초대 링크 생성 UI
5. 초대 수락 후 `relationship_links` 연결
6. 상담 세션 생성 Edge Function
